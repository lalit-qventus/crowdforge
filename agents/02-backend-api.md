...
## Core Services
1. **Auth Service** — registration, login, OAuth (GitHub, Google), identity verification score tracking, graduated trust levels (Observer through Founder's Circle)
...
## Reference Docs
- `06-architecture/design.md` — system architecture, service diagram, tech choices
- `02-karma-system/design.md` — karma formulas and rules
- `03-fraud-prevention/design.md` — trust levels, rate limits, behavioral signals
- `05-spawn-protection/design.md` — project lifecycle phases, contribution rules per phase
