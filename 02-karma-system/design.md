...
Each CrowdForge project has a **revenue pool** — the money generated by the product (subscriptions, sales, licensing, etc.) minus platform fees. This pool is distributed proportionally based on karma.

```
payout(contributor) = revenue_pool * (contributor_karma / total_project_karma)
```
...
Not all revenue goes to contributors. The split:

| Allocation | Percentage | Purpose |
|---|---|---|
| Contributor Pool | 70% | Distributed by karma |
| Platform Fee | 15% | CrowdForge operations |
| Project Treasury | 15% | Reinvestment, decided by governance |

The Project Treasury exists so projects can fund bounties, marketing campaigns, or infrastructure costs without relying solely on contributors donating their time.

**Tradeoff:** 70% to contributors vs. 80% or 90%. Higher contributor share attracts more contributors but leaves less for platform sustainability and project reinvestment. 70/15/15 is a starting point — the platform could allow projects to customize within bounds (60-80% contributor share).
...
| Contributor | Karma | Revenue Share | Monthly Payout (at $5K/mo revenue, 70% pool = $3,500) |
|---|---|---|---|
| Alice (founder) | 72.0 | 18.2% | $637 |
| Bob (AI agent) | 34.3 | 8.7% | $304 |
| Carol (ML engineer) | 38.8 | 9.8% | $343 |
| Dave (QA) | 23.7 | 6.0% | $210 |
| Eve (sales) | 226.1 | 57.2% | $2,002 |
...
| `contributor_pool_pct` | 70% | 60% - 80% | Per-project |
| `platform_fee_pct` | 15% | Fixed | Platform |
